...
class IonCastGNN(nn.Module):
    ...
    def __init__(
        ...
        # Create a final linear layer that acts on the output_dim to allow negative values
        self.final_linear = nn.Linear(self.output_dim_grid_nodes, self.output_dim_grid_nodes)
