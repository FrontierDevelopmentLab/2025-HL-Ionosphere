...
declare -a ABLATIONS=(
    ...
    "--aux_dataset sunmoon quasidipole celestrak omni set --date_start 2018-01-01T00:00:00 --date_end 2020-12-31T23:59:59 --target_dir /home/jupyter/halil_debug/ioncastgnn-fulldataset-dilation128-residual-oct22-technical-showcase-ablation-solarmin --date_dilation 18 --residual_target"  
...
do
    ...
    CUDA_VISIBLE_DEVICES=0 python run_ioncast.py ${ABLATIONS[$i]} --data_dir /home/jupyter/data --mode train --num_workers 12 --batch_size 1 --model_type IonCastGNN --epochs 14 --learning_rate 3e-4 --weight_decay 0.0 --context_window 8 --prediction_window 1 --num_evals 1 --jpld_weight 2.0 --mesh_level 6 --device cuda --valid_event_id validation_events_5 --valid_every_nth_epoch 2 --save_all_models --max_valid_samples 1400 --wandb_run_name IonCastGNN_sunlocked_technical_showcase_ablation_$((i+1)) --lead_times 180
done
