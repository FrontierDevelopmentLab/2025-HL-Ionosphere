...
matplotlib.use('Agg')
######## NOTE: THESE Distributed funcs are from gpt directly ##############
    ...
    with Tee(log_file):
        ...
        if args.mode == 'train':
            ...
            if args.cache_dir:
                ...
                if args.partition_size > 1:
                    # NOTE: hacky fix below to see if this works without physics nemos DistributedManager
                    # should be refactored later assuming this works. (ie change args.partition_size what i tmeans maybe?)
            ...
            if len(model_files) > 0:
                ...
                if args.model_type == 'IonCastConvLSTM':
                    ...
                    model = IonCastGNN(
                        ...
                        partition_size=1, #NOTE: THIS IS HARDCODED FOR NOW args.partition_size, # Partition size for the GNN model
            ...
            cleanup_ddp() # NOTE: THIS IS FOR DISTRIBUTED TRAINING NEWLY ADDED
